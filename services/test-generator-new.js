...
class TestGenerator {
  ...
  async generateFromRequirements(requirements) {
    ...
    try {
      ...
      const analysis = await this.analyzer.analyzeRequirements(requirements.content);
  ...
  async generateSteps(baseFileName, featureContent) {
    ...
    const stepsContent = this.templateGenerator.generateStepsFromFeature(featureContent);
  ...
  async generatePages(baseFileName, stepsContent) {
    ...
    const pagesContent = this.templateGenerator.generatePageFromSteps(stepsContent);
  ...
  async generateTests(baseFileName, pagesContent) {
    ...
    const testsContent = this.templateGenerator.generateTestsFromPages(pagesContent);
